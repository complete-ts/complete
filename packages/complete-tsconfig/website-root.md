...
If you do not want to use the `complete-lint` meta-package, then you can install this package manually. For example, if you use the [npm](https://docs.npmjs.com/cli/commands/npm) package manager:
