...
| [consistent-object-braces](/eslint-plugin-complete/rules/consistent-object-braces)                         | Requires object brace spacing to match the property count                                                   | ✅  | 🔧  |     |
...
| [no-redundant-jsdoc-default](/eslint-plugin-complete/rules/no-redundant-jsdoc-default)                     | Disallows setting object properties to their JSDoc default values                                           | ✅  |     | 💭  |
...
| [prefer-is-array](/eslint-plugin-complete/rules/prefer-is-array)                                           | Requires using the complete-common isArray helper instead of Array.isArray                                  | ✅  | 🔧  |     |
...
| [prefer-unknown-type-annotations](/eslint-plugin-complete/rules/prefer-unknown-type-annotations)           | Require variable type annotations over as unknown assertions                                                | ✅  | 🔧  |     |
| [require-ascii](/eslint-plugin-complete/rules/require-ascii)                                               | Require code and comments to only contain ASCII characters                                                  | ✅  |     |     |
...
| [sort-destructured-properties](/eslint-plugin-complete/rules/sort-destructured-properties)                 | Requires destructured object properties to match the declared type order                                    | ✅  | 🔧  | 💭  |
| [sort-objects](/eslint-plugin-complete/rules/sort-objects)                                                 | Requires object properties to match the declared type order or alphabetical order                           | ✅  | 🔧  | 💭  |
...
| [type-declaration-immutability](/eslint-plugin-complete/rules/type-declaration-immutability)               | Enforces that interfaces are immutable                                                                      | ✅  |     | 💭  |
