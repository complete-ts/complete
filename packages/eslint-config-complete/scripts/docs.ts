...
const MARKDOWN_HEADER = `# \`${PACKAGE_NAME}\`
...
## Why Do I Need \`${PACKAGE_NAME}\`?

Your codebase deserves to be safe as possible and \`${PACKAGE_NAME}\` is the most comprehensive ESLint config out there.
